...
class TestMaze(unittest.TestCase):
    ...
    def test_cell_position(self):
        ...
        for row in range(5):
            for col in range(5):
                cell = self.maze.get_cells()[row][col]
    ...
    def test_create_entrance(self):
        ...
        entrance_cell = self.maze.get_cells()[0][0]
    ...
    def test_create_exit(self):
        ...
        entrance_cell = self.maze.get_cells()[4][4]
