...
def main():
    ...
    #timer.measure_multiple_solve_time("bfs_iterative", 100)
    #timer.measure_multiple_solve_time("dfs_iterative", 100)
    maze.solve("bfs_iterative")
    maze.maze_regenerate()
    maze.solve("dfs_iterative")
...
def maze_setup_with_window(seed = None):
    ...
    return Maze(maze_x_offset, maze_y_offset, maze_rows, maze_cols, cell_width, cell_height, window,seed)
